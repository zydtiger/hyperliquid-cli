...
def test_watch_endpoint_success():
    ...
    client.get_watch_snapshot.assert_called_once_with("BTC", "5m")
...
def test_watch_endpoint_passes_interval_query():
    ...
    assert response.status_code == 200
    client.get_watch_snapshot.assert_called_once_with("BTC", "1h")
...
def test_watch_endpoint_accepts_extended_interval_query():
    ...
    assert response.status_code == 200
    client.get_watch_snapshot.assert_called_once_with("BTC", "1d")
...
def test_watch_endpoint_supports_spot_pairs():
    ...
    client.get_watch_snapshot.assert_called_once_with("UBTC/USDC", "5m")
